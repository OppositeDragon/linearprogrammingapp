...
part of 'graphic_data_model.dart';
...
mixin _$GraphicDataModel {
  ...
  List<List<Point<double>>> get feasibleRegionMatrixPoints =>
      throw _privateConstructorUsedError;
  String get feasibleRegionText => throw _privateConstructorUsedError;

  @JsonKey(ignore: true)
  $GraphicDataModelCopyWith<GraphicDataModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GraphicDataModelCopyWith<$Res> {
  factory $GraphicDataModelCopyWith(
          GraphicDataModel value, $Res Function(GraphicDataModel) then) =
      _$GraphicDataModelCopyWithImpl<$Res, GraphicDataModel>;
  @useResult
  $Res call(
      {double xLimit,
      double yLimit,
...
/// @nodoc
class _$GraphicDataModelCopyWithImpl<$Res, $Val extends GraphicDataModel>
    implements $GraphicDataModelCopyWith<$Res> {
  _$GraphicDataModelCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      xLimit: null == xLimit
          ? _value.xLimit
          : xLimit // ignore: cast_nullable_to_non_nullable
              as double,
      yLimit: null == yLimit
          ? _value.yLimit
          : yLimit // ignore: cast_nullable_to_non_nullable
              as double,
      answer: null == answer
          ? _value.answer
      ...
      feasibleRegionMatrixPoints: null == feasibleRegionMatrixPoints
          ...
          : feasibleRegionMatrixPoints // ignore: cast_nullable_to_non_nullable
              as List<List<Point<double>>>,
      feasibleRegionText: null == feasibleRegionText
          ? _value.feasibleRegionText
          : feasibleRegionText // ignore: cast_nullable_to_non_nullable
              as String,
    ) as $Val);
  }
}
...
/// @nodoc
abstract class _$$GraphicDataModelImplCopyWith<$Res>
    implements $GraphicDataModelCopyWith<$Res> {
  factory _$$GraphicDataModelImplCopyWith(_$GraphicDataModelImpl value,
          $Res Function(_$GraphicDataModelImpl) then) =
      __$$GraphicDataModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {double xLimit,
...
/// @nodoc
class __$$GraphicDataModelImplCopyWithImpl<$Res>
    extends _$GraphicDataModelCopyWithImpl<$Res, _$GraphicDataModelImpl>
    implements _$$GraphicDataModelImplCopyWith<$Res> {
  __$$GraphicDataModelImplCopyWithImpl(_$GraphicDataModelImpl _value,
      $Res Function(_$GraphicDataModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GraphicDataModelImpl(
      xLimit: null == xLimit
          ? _value.xLimit
          : xLimit // ignore: cast_nullable_to_non_nullable
              as double,
...
class _$GraphicDataModelImpl implements _GraphicDataModel {
  const _$GraphicDataModelImpl(
  ...
  @override
  List<List<Point<double>>> get feasibleRegionMatrixPoints {
    if (_feasibleRegionMatrixPoints is EqualUnmodifiableListView)
      return _feasibleRegionMatrixPoints;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_feasibleRegionMatrixPoints);
  }

  @override
  @JsonKey()
  final String feasibleRegionText;
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.feasibleRegionText, feasibleRegionText) ||
                other.feasibleRegionText == feasibleRegionText));
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GraphicDataModelImplCopyWith<_$GraphicDataModelImpl> get copyWith =>
      __$$GraphicDataModelImplCopyWithImpl<_$GraphicDataModelImpl>(
          this, _$identity);
}

abstract class _GraphicDataModel implements GraphicDataModel {
  const factory _GraphicDataModel(
      {required final double xLimit,
      required final double yLimit,
      required final Point<double> answer,
      required final ({
        Point<double> p1,
        Point<double> p2
      }) objectiveFunctionIntersections,
