...
part of 'algebraic_data_model.dart';
...
mixin _$AlgebraicDataModel {
  ...
  @JsonKey(ignore: true)
  $AlgebraicDataModelCopyWith<AlgebraicDataModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AlgebraicDataModelCopyWith<$Res> {
  factory $AlgebraicDataModelCopyWith(
          AlgebraicDataModel value, $Res Function(AlgebraicDataModel) then) =
      _$AlgebraicDataModelCopyWithImpl<$Res, AlgebraicDataModel>;
  @useResult
  $Res call(
...
/// @nodoc
class _$AlgebraicDataModelCopyWithImpl<$Res, $Val extends AlgebraicDataModel>
    implements $AlgebraicDataModelCopyWith<$Res> {
  _$AlgebraicDataModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$AlgebraicDataModelImplCopyWith<$Res>
    implements $AlgebraicDataModelCopyWith<$Res> {
  factory _$$AlgebraicDataModelImplCopyWith(_$AlgebraicDataModelImpl value,
          $Res Function(_$AlgebraicDataModelImpl) then) =
      __$$AlgebraicDataModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {List<List<double>> standardForm,
...
/// @nodoc
class __$$AlgebraicDataModelImplCopyWithImpl<$Res>
    extends _$AlgebraicDataModelCopyWithImpl<$Res, _$AlgebraicDataModelImpl>
    implements _$$AlgebraicDataModelImplCopyWith<$Res> {
  __$$AlgebraicDataModelImplCopyWithImpl(_$AlgebraicDataModelImpl _value,
      $Res Function(_$AlgebraicDataModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$AlgebraicDataModelImpl(
      standardForm: null == standardForm
...
class _$AlgebraicDataModelImpl implements _AlgebraicDataModel {
  const _$AlgebraicDataModelImpl(
  ...
  @override
  String toString() {
    return 'AlgebraicDataModel(standardForm: $standardForm, constraintWithSlack: $constraintWithSlack, constraintsString: $constraintsString, rightSide: $rightSide, rightSideString: $rightSideString, greaterThanZeroCondition: $greaterThanZeroCondition, combinationsEquation: $combinationsEquation)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$AlgebraicDataModelImplCopyWith<_$AlgebraicDataModelImpl> get copyWith =>
      __$$AlgebraicDataModelImplCopyWithImpl<_$AlgebraicDataModelImpl>(
          this, _$identity);
}

abstract class _AlgebraicDataModel implements AlgebraicDataModel {
  const factory _AlgebraicDataModel(
      {required final List<List<double>> standardForm,
      required final List<List<double>> constraintWithSlack,
      required final List<List<String>> constraintsString,
      required final List<double> rightSide,
      ...
      required final String combinationsEquation}) = _$AlgebraicDataModelImpl;
...
mixin _$AlgebraicSteps {
  ...
  @JsonKey(ignore: true)
  $AlgebraicStepsCopyWith<AlgebraicSteps> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AlgebraicStepsCopyWith<$Res> {
  factory $AlgebraicStepsCopyWith(
          AlgebraicSteps value, $Res Function(AlgebraicSteps) then) =
      _$AlgebraicStepsCopyWithImpl<$Res, AlgebraicSteps>;
  @useResult
  $Res call(
      {String header,
      int step,
...
/// @nodoc
class _$AlgebraicStepsCopyWithImpl<$Res, $Val extends AlgebraicSteps>
    implements $AlgebraicStepsCopyWith<$Res> {
  _$AlgebraicStepsCopyWithImpl(this._value, this._then);
...
class __$$StepsForAlgebraicImplCopyWithImpl<$Res>
    extends _$AlgebraicStepsCopyWithImpl<$Res, _$StepsForAlgebraicImpl>
...
class _$StepsForAlgebraicImpl implements _StepsForAlgebraic {
  ...
  @override
  String toString() {
    return 'AlgebraicSteps(header: $header, step: $step, whereVarEqualsZero: $whereVarEqualsZero, solutions: $solutions, solutionsString: $solutionsString, matrix: $matrix, solutionString: $solutionString, objectiveFunctionSolution: $objectiveFunctionSolution)';
  }
...
abstract class _StepsForAlgebraic implements AlgebraicSteps {
...
mixin _$AlgebraicAnswer {
  ...
  int get step => throw _privateConstructorUsedError;
  List<AlgebraicSteps> get steps => throw _privateConstructorUsedError;

  @JsonKey(ignore: true)
  $AlgebraicAnswerCopyWith<AlgebraicAnswer> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AlgebraicAnswerCopyWith<$Res> {
  factory $AlgebraicAnswerCopyWith(
          AlgebraicAnswer value, $Res Function(AlgebraicAnswer) then) =
      _$AlgebraicAnswerCopyWithImpl<$Res, AlgebraicAnswer>;
  @useResult
  $Res call(
      {double definitiveSolution,
      String? finalSolutionString,
      int step,
      List<AlgebraicSteps> steps});
}

/// @nodoc
class _$AlgebraicAnswerCopyWithImpl<$Res, $Val extends AlgebraicAnswer>
    implements $AlgebraicAnswerCopyWith<$Res> {
  _$AlgebraicAnswerCopyWithImpl(this._value, this._then);
    ...
    return _then(_value.copyWith(
      ...
      steps: null == steps
          ...
          : steps // ignore: cast_nullable_to_non_nullable
              as List<AlgebraicSteps>,
    ) as $Val);
  }
}

/// @nodoc
abstract class _$$AlgebraicAnswerImplCopyWith<$Res>
    implements $AlgebraicAnswerCopyWith<$Res> {
  factory _$$AlgebraicAnswerImplCopyWith(_$AlgebraicAnswerImpl value,
          $Res Function(_$AlgebraicAnswerImpl) then) =
      __$$AlgebraicAnswerImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {double definitiveSolution,
...
/// @nodoc
class __$$AlgebraicAnswerImplCopyWithImpl<$Res>
    extends _$AlgebraicAnswerCopyWithImpl<$Res, _$AlgebraicAnswerImpl>
    implements _$$AlgebraicAnswerImplCopyWith<$Res> {
  __$$AlgebraicAnswerImplCopyWithImpl(
      _$AlgebraicAnswerImpl _value, $Res Function(_$AlgebraicAnswerImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$AlgebraicAnswerImpl(
      definitiveSolution: null == definitiveSolution
          ? _value.definitiveSolution
          : definitiveSolution // ignore: cast_nullable_to_non_nullable
              as double,
...
class _$AlgebraicAnswerImpl implements _AlgebraicAnswer {
  const _$AlgebraicAnswerImpl(
      {required this.definitiveSolution,
      required this.finalSolutionString,
      required this.step,
      required final List<AlgebraicSteps> steps})
      : _steps = steps;
  ...
  @override
  final int step;
  final List<AlgebraicSteps> _steps;
  @override
  List<AlgebraicSteps> get steps {
  ...
  @override
  String toString() {
    return 'AlgebraicAnswer(definitiveSolution: $definitiveSolution, finalSolutionString: $finalSolutionString, step: $step, steps: $steps)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$AlgebraicAnswerImplCopyWith<_$AlgebraicAnswerImpl> get copyWith =>
      __$$AlgebraicAnswerImplCopyWithImpl<_$AlgebraicAnswerImpl>(
          this, _$identity);
}

abstract class _AlgebraicAnswer implements AlgebraicAnswer {
  const factory _AlgebraicAnswer(
      {required final double definitiveSolution,
      required final String? finalSolutionString,
      required final int step,
      required final List<AlgebraicSteps> steps}) = _$AlgebraicAnswerImpl;
